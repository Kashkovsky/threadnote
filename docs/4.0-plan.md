...
the delivery plan and acceptance history; they are not an alternative description of the current product.
...
- keep vectors in the checksummed sidecar while measured exact-scan behavior meets budgets;
...
5. SQLite lexical schema and vector sidecar replacement criteria;
