...
import type {CodeGraphDatabaseSessionOptions, CodeGraphStoreShape} from './store_shape.js';
export type {
...
export {codeGraphPersistentExtensionSchemaCompatible};
...
import {
  ...
  configureConnection,
  configurePublicationDurability,
