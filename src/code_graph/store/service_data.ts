...
import {selectScopeApplicability, recordScopeApplicability} from './scope_applicability.js';
...
import {selectCachedCommittedFileKeys} from './query_core.js';
import {discardInvalidCachedFacts} from './cache_repair.js';
import {stageActivationFiles, activationMode, type CodeGraphWriterGate} from './build_core.js';
import {
...
import {ensureReadySnapshotAnalysisSummary} from './activation_persistent.js';
import {pruneRetiredSnapshotRows} from './retirement.js';
import {selectResumableForcedBuild, selectResumableBuildById} from './resolution_core.js';
import {
...
} from './materialization_spool_lifecycle.js';
