...
import {CODE_GRAPH_SNAPSHOT_LEASE_EXPIRY_INDEX, codeGraphReconciliationIndexState} from './reconciliation_core.js';
import {codeGraphWorktreeReconciliationSchemaCompatible} from './reconciliation.js';
import {ensureCodeGraphFileBlobAuthority} from './cache_authority.js';
import {
...
import {codeGraphScopeAuthorityInstalled, migrateCodeGraphScopeAuthority} from './scope_schema.js';
import {CODE_GRAPH_SCOPE_CURSOR_MAXIMUM_BYTES, CODE_GRAPH_SCOPE_CURSOR_PATTERN} from './scope_cursor.js';
