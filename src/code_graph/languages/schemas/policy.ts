const LOW_SIGNAL_STRUCTURED_PATH =
  /(?:^|\/)(?:__snapshots__|snapshots?|golden[-_]data|goldens?|fixtures?|oplogs?|evaluations?|evals?|datasets?|test[-_]?data|animations?)(?:\/|$)|(?:^|\/)[^/]*(?:snapshot|golden|fixture|oplog|evaluation|dataset|animation)[^/]*\.(?:jsonc?|ya?ml)$/i;
