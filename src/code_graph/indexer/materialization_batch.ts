...
import type {PersistentMaterializationTransactionCandidate} from './materialization.js';
import type {CodeGraphSecondaryIndexRestorationProgressCallback} from '../store/models.js';
import type {
  CodeGraphEdge,
