...
import {estimatedMaterializationStorageBytes} from './materialization.js';
import type {CodeGraphBuildAndActivateInput, CodeGraphIndexResourceGate} from './types.js';
