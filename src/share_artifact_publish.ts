...
} from './share_artifact_support.js';

import type {BundleMemberFile, ResolvedTeam, ShareArtifactMetadata, ShareArtifactResult} from './share_core.js';
...
import {assertSharedWorktreeFileReady, publishShareGitChange, writeSharedWorktreeFile} from './share_git.js';
