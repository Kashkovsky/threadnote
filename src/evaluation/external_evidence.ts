...
const RELEASE_SITE_REQUIRED_MEASUREMENTS = [
  ...
  {name: 'one-file-reindex-registration-lock-and-database-setup', unit: 'milliseconds'},
  {name: 'one-file-reindex-post-committed-scan-overlay-and-workspace', unit: 'milliseconds'},
