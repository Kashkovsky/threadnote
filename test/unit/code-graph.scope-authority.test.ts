...
import {recordScopeApplicability, selectScopeApplicability} from '../../src/code_graph/store/scope/applicability.js';
import {
  claimRemovedViewCleanupCandidates,
  claimWorktreeReconciliationCandidates,
} from '../../src/code_graph/store/reconciliation.js';
import {migrateCodeGraphScopeAuthority} from '../../src/code_graph/store/scope/schema.js';
import {promoteSnapshot} from '../../src/code_graph/store/resolution.js';
import {prepareSnapshotPromotionCapacity} from '../../src/code_graph/store/build/preparation.js';
