...
const PYTHON_SYSTEM_CERTS_MODULE = 'pip_system_certs';
const PYTHON_SYSTEM_CERTS_PACKAGE = 'pip-system-certs';
const LAUNCHD_LABEL = 'io.threadnote.openviking';
const MAX_SECRET_MATCHES_TO_PRINT = 5;
const START_HEALTH_POLL_INTERVAL_MS = 500;
const START_HEALTH_TIMEOUT_MS = 15_000;
...
function openVikingHealthUrl(config: RuntimeConfig): string {
  return `http://${config.host}:${config.port}/health`;
}

function openVikingLogPath(config: RuntimeConfig): string {
